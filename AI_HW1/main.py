...
for t in T:
  ...
  acc = utils.evaluate(clf, trainData)
  trainAccuracy.append(acc)

  print('\nEvaluate your classifier with test dataset')
  acc = utils.evaluate(clf, testData)
  testAccuracy.append(acc)
  
plt.plot(T, trainAccuracy, 's-', color='r', label="train")
plt.plot(T, testAccuracy, 'o-', color='g', label="test")
plt.title("Relation between T and Accuracy")
...
detection.detect('data/detect/ownData.txt', clf)